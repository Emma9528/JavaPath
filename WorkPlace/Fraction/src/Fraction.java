...
class Fraction {
  ...
  public static void main(String[] argv) {
    ...
    Fraction sumOfThree = new Fraction(f1.numerator*f2.denominator*f0.denominator+f2.numerator*f1.denominator*f0.denominator+f0.numerator*f1.denominator*f2.denominator,f1.denominator*f2.denominator*f0.denominator);           // Sum of f0, f1, and f2.
